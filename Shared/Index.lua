...
function NanosWorldVehicles.Pickup:Constructor(location, rotation)
	...
	self:SetWheel(0, "Wheel_Front_Left",  30, 18, 55, Vector(), true, true, false, false, false, 5000, 3000, 1500, 1, 4, 20, 20, 200, 60, 6, 10, 0, 0.4, 0.1)
	self:SetWheel(1, "Wheel_Front_Right", 30, 18, 55, Vector(), true, true, false, false, false, 5000, 3000, 1500, 1, 4, 20, 20, 200, 60, 6, 10, 0, 0.4, 0.1)
	self:SetWheel(2, "Wheel_Rear_Left",   30, 18,  0, Vector(), true, true,  true, false, false, 5000, 3000, 1500, 1, 3, 20, 20, 200, 60, 6, 10, 0, 0.4, 0.1)
	self:SetWheel(3, "Wheel_Rear_Right",  30, 18,  0, Vector(), true, true,  true, false, false, 5000, 3000, 1500, 1, 3, 20, 20, 200, 60, 6, 10, 0, 0.4, 0.1)
